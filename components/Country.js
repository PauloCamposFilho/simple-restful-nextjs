  ...
  return (
    <div className={styles.country}>
      ...
      <div className={styles.map_app_container}>
        <a className={styles.map_app_info} href={props.maps.openStreetMaps} target='_blank'><Image className={styles.map_app_icon} alt='OpenStreetMaps icon'  src='/osm.svg' /><span>View in OpenStreetMaps</span></a>
      </div>
      <div className={styles.map_app_container}>
        <a className={styles.map_app_info} href={props.maps.googleMaps} target='_blank'><Image className={styles.map_app_icon} alt='GoogleMaps icon' src='/gmaps.svg' /><span>View in GoogleMaps</span></a>
      </div>
    </div>
  );
};
